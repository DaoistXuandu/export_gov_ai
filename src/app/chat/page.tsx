...
const first_message = [
    ...
    "Tanya Regulasi memastikan produk Anda mematuhi regulasi dan standar mutu di negara tujuan. Terintegrasi dengan sumber resmi Inatrims, fitur ini menyediakan jawaban cepat dan akurat terkait regulasi dan standar mutu ekspor di negara tujuan, sehingga Anda dapat memastikan kepatuhan tanpa kerumitan. Dapatkan informasi yang Anda butuhkan untuk memastikan produk Anda siap menembus pasar internasional dengan mudah dan aman.",
    "Agent Product Research & Development membantu Anda menciptakan produk yang lebih inovatif dan kompetitif. Dengan teknologi AI yang bekerja secara otomatis, fitur ini menelusuri berbagai sumber informasi untuk memberikan ide-ide segar dan rekomendasi pengembangan produk. Dari peningkatan efisiensi hingga inovasi fitur, laporan yang dihasilkan memungkinkan Anda membuat keputusan cerdas dan cepat dalam menciptakan produk unggulan yang sesuai dengan kebutuhan pasar. Biarkan AI kami melakukan pencarian, sementara Anda memanfaatkan hasilnya untuk mengembangkan produk yang siap bersaing di Pasar ASEAN.",
    "Tanya Pengiriman memudahkan Anda menemukan solusi pengiriman ekspor terbaik. Dengan teknologi AI, fitur ini menyediakan informasi terkini dan daftar lokasi ekspor terdekat untuk mendukung pengiriman ekspor Anda.",
